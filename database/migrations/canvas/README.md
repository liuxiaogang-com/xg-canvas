...
an exact, non-null Catalog model revision pin and catalog epoch. `execution_mode`
selects the `live` or `demo` executor; both modes use the same pinned task shape.
